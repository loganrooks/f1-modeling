...
| `specs/spec-debrief-D-carry-forward-synthesis-and-next-initiative-changes.md` | Convert findings into concrete changes, dispositions, and closeout summary | Outputs of Specs A-C; `CLAUDE.md`; `.planning/ROADMAP.md`; `.planning/TECH-DEBT.md`; `.planning/STATE.md` | `CHANGES-BEFORE-NEXT-INITIATIVE.md`, `CARRY-FORWARD-LEDGER.md`, `DEBRIEF-SUMMARY.md` | Keep final synthesis local |
