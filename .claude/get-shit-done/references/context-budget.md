...
The keys live in `.claude/settings.json` (project) or `/home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/settings.json` (global) — **not** in `.planning/config.json`:
