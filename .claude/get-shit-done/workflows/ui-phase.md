...
```markdown
Read /home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/agents/gsd-ui-checker.md for instructions.
