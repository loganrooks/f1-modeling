...
**If doesn't exist:** Create from template at `/home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/get-shit-done/templates/retrospective.md`.
