...
```bash
INIT=$(node "/home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/rookslog/workspace/projects/f1-modeling/.claude/worktrees/gsd-local-install-2026-05/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
